...
Please use this repository's **Security** tab and its private vulnerability reporting form. Do not open a public issue for a suspected vulnerability.
...
The latest version published on the Cursor Marketplace is supported. Security fixes are released as a new reviewed plugin version.
